            ...
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
              <div className="w-100">
                {this.props.logoPreview && (
                  <img src={this.props.logoPreview} alt="Company Logo" style={{ maxWidth: '150px', marginBottom: '20px' }} />
                )}
                <h4 className="fw-bold my-2">{this.props.info.billFrom || 'Invoice Maker'}</h4>
