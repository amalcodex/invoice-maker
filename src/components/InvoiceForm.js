...
import currencyData from './currency.json'; // Assuming you have currency data in currency.json
...
class InvoiceForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      filteredCurrencies: currencyData, // Initially set to all currencies
      searchQuery: '' // For currency search
    };
    this.state.items = [
      {
        id: 0,
  ...
  render() {
    return (
      <Form onSubmit={this.openModal}>
        <Row>
          <Col md={8} lg={9}>
            <Card className="p-4 p-xl-5 my-3 my-xl-4 shadow-lg">
          ...
          <Col md={4} lg={3}>
            <div className="sticky-top pt-md-3 pt-xl-4">
              <Button variant="warning" type="submit" className="d-block w-100">Review Invoice</Button>
          ...
          <Col>
            <Form.Group className="mb-3">
              ...
              <Form.Select onChange={(event) => this.editField(event)} name="currency" className="btn btn-light my-1" aria-label="Change Currency">
